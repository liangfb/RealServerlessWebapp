...
//     res.append('Set-Cookie', 'userId=' + doc.userId + ';path=/');
//     res.append('Set-Cookie', 'userName=' + doc.userId + ';path=/');
...
router.post('/logout',function(req,res,next){
  ...
  */
  res.append('Set-Cookie', 'userId=' + doc.userId + ';Path=/;Expires=2000-01-01');
  res.json({
    status:'0',
    msg:'',
    result:'退出成功',
