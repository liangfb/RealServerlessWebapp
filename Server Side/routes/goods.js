...
mongoose.connect('mongodb://172.17.3.59:27017/shop');
...
router.get("/list",function(req,res,next){
  ...
  let pagesize = req.param("pagesize") * 1; //每页有多少条数据
  console.log('the page is:' + page);

  let sortparam = req.param("sort");
  
  console.log('the sort is:' + sortparam);
  ...
  let goodModel = Goods.find(param).limit(Number(pagesize)).skip(Number(skip));
//  goodModel.sort({'salePrice':sortparam})
